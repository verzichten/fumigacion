...
import { getFormData, createOrdenServicio, addDireccionToCliente } from "../actions";
...
export default function NuevoServicioPage() {
  ...
  // Update addresses when client changes
  useEffect(() => {
  ...
  const handleSaveAddress = async () => {
    ...
    if (result.error) {
      ...
      // Update client list to reflect change if revisited
              ...
              <div className="space-y-2">
                ...
                >
                  Dirección del Cliente <span className="text-red-500">*</span>
                                ...
                                <Select
                                    key={selectedAddressId} // Add key to force re-render when selectedAddressId changes
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                ...
                <Select name="estado" defaultValue="SERVICIO_NUEVO">
                  <SelectTrigger className="h-11">
